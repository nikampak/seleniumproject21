...
public class P3_Checkbox_Practices {
    public static void main(String[] args) throws InterruptedException {
        ...
        if (!checkbox1.isSelected()){
            ...
            System.err.println("Checkbox#1 is selected. Default value verification FAILED!");
        }
        //3. Confirm checkbox #2 is SELECTED by default.
        if (checkbox2.isSelected()){
            System.out.println("Checkbox#2 is selected. Default value verification PASSED!");
        }else{
            System.err.println("Checkbox#2 is NOT selected. Default value verification FAILED!");
        }
        ...
        if (checkbox1.isSelected()){
            ...
            System.err.println("Checkbox#1 is NOT selected. Default value verification FAILED!");
        }
        //7. Confirm checkbox #2 is NOT selected.
        if (!checkbox2.isSelected()){
            System.out.println("Checkbox#2 is NOT selected. Default value verification PASSED!");
        }else{
            System.err.println("Checkbox#2 is selected. Default value verification FAILED!");
        }
        // ************
